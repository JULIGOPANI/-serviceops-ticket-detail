...
23.In this prompt i am giving a new task to you which we haven't even think of it in this project's conversation so ask me anything if you have doubt about and don't make assumptions : Now let me give you context brfore design it. we are adding new section and giving split section icon to the right and left of the section. but we want to achieve for all these Basic, Visual and Custom section's all widgets 