...
22.Now need to add 2 sections by showing max 4 cards inside it. 1.Favrouite Services , 2. Most used services. for reference i can give you old existing product's card UI design , you need to refine it ane make looks like our currnet component like(action cards UI). this is our current portal's UI : 